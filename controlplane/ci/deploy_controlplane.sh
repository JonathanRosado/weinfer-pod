...
H100_POD_IMAGE="ghcr.io/jonathanrosado/weinfer-pod@sha256:6589f62322501667181019bb39e3aefb0e993a103668543e9ecc8c754b1bbcf6"
...
H100_BOOTSTRAP_HARDWARE='[{"gpu_sku":"NVIDIA H100 NVL","cuda_class":"12","vram_gb":94,"throughput_seed_tokens_per_sec":2600,"throughput_seed_kind":"traffic_observed_cross_identity","throughput_seed_source":"sealed company/research/bench_runs/cycle3-tokenbench-scan1/tb-sweep/points/n-sweep__seqs8-batch8192-cacheoff__n-32__arrival-saturation__repeat-0/load-report.json; sha256=f73161fa3331599e161970e643a9d3c7b4bdb8f2adcecc5145c792448cb9ec44; command.json sha256=4e4b5f8229bec7bfe0e3896be892ce9aa76d41bf5e71502ef36998ada2d43c37; max_num_seqs=8; max_num_batched_tokens=8192; prefix_caching=false; evidence_hardware=NVIDIA H100 80GB HBM3; target_hardware=NVIDIA H100 NVL; target_launch_identity_unmeasured; model=gpt-oss-120b; tokenizer_revision=b5c939de8f754692c1647ca79fbf85e8c1e70f8a; observed_tps=2768.891832; require_stable=false; block_throughput_cv=0.49436819; block_count=5; point_estimate_only_no_resolved_seqs8_gain; policy_prior=2600; new immutable image and worker are unmeasured","boot_seed_micros":1200000000,"drain_seed_micros":30000000,"fixed_seed_kind":"policy_prior","fixed_seed_source":"cost-derived readiness ceiling: 1200s at 2700000 uUSD/hr = 900000 uUSD; drain=30s policy allowance; no lifecycle observation for the NVIDIA H100 NVL launch identity, image, and worker"}]'
...
if [ "$SERVING_PROFILE" = "gpt-oss-120b-h100-v1" ]; then
  ...
  POOL_NAME="community-gpt-oss-120b-h100-nvl-0"
  LEGACY_GPU_TYPE="NVIDIA H100 NVL"
  MIN_VRAM_GB="94"
  MAX_GPU_RATE="2.70"
  POD_DISK_GB="120"
fi
