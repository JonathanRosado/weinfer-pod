...
assert value["WEINFER_GATEWAY_SHA256"] == "5675db476152640df707b272e7805a5248b1a4eec923ac837227791076b761ba"
...
text = path.read_text()
text = text.replace('GW_TAG="gateway-v0.9.0"', 'GW_TAG="gateway-v0.13.0"', 1)
...
echo "RETENTION SUBSTRATE REGRESSION PASS: frozen v0.9/A4500 accepted; live v0.13/multi-SKU and tamper refused"
