...
assert value["WEINFER_GATEWAY_SHA256"] == "fc9456b8bf79eab98718b74c34baa0bdacdc42581aefadb40a7d2bcdcf58335d"
...
text = path.read_text()
text = text.replace('GW_TAG="gateway-v0.9.0"', 'GW_TAG="gateway-v0.16.0"', 1)
...
echo "RETENTION SUBSTRATE REGRESSION PASS: frozen v0.9/A4500 accepted; live v0.16/multi-SKU and tamper refused"
