...
assert value["WEINFER_GATEWAY_SHA256"] == "5bb68314d4829b30d9b18589c946f2808a704f50dc41b396d82980632e4e1d91"
...
text = path.read_text()
text = text.replace('GW_TAG="gateway-v0.9.0"', 'GW_TAG="gateway-v0.10.0"', 1)
...
echo "RETENTION SUBSTRATE REGRESSION PASS: frozen v0.9/A4500 accepted; live v0.10/multi-SKU and tamper refused"
